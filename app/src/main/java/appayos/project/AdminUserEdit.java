...
public class AdminUserEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adminCheckbox = findViewById(R.id.editUser_admin);
        technicianCheckbox = findViewById(R.id.editUser_technician);
        ...
        technicianCheckbox.setChecked(user.isTechnician());
